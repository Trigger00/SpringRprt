			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form">
						...
						<a href="20150010/editar"> Editar </a> &nbsp; <input type="text"
							name="nombre" value="${alumnos.matricula}" />
						...
						<table>
							...
							<c:forEach var="i" items="${alumnos2}">
								<tr>
									<th>${i.matricula}</th>
									<th>${i.alumnosEsp.espNombre}</th>
									<th>${i.alumnosFac.facNombre}</th>
								</tr>
							</c:forEach>
						</table>
